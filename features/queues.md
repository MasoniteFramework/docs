...
| `failed_jobs` | Specifies the table to store failed_jobs in. Set to `None` to not save failed jobs. |
...
| Option     | Description                                                  |
| ---------- | ------------------------------------------------------------ |
| `blocking` | A boolean value on whether jobs should run synchronously. <br />Useful for debugging purposes. |
