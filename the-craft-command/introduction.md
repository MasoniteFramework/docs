...
```text
$ python craft validator LoginValidator
```
...
```bash
$ python craft model:docstring table_name
```
...
```text
$ python craft controller Dashboard -r -e
```
...
```text
$ python craft model ModelName -s -m
```
...
```text
$ python craft model ModelName
$ python craft seed ModelName
$ python craft migration create_tablename_table --create tablename
```
...
```text
$ python craft package name_of_package
```
...
```text
$ python craft serve --dont-reload
```

or the shorthand

```text
$ python craft serve -d
```
...
```text
$ python craft serve --live-reload
```
...
```text
$ python craft serve -b 127.0.0.1 -p 8080
```
...
```python
$ python craft provider ProviderName
```

You can also optionally specify a tag:

```python
$ python craft provider ProviderName --tag name
```
