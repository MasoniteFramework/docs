...
Which will target `test.example.com/dashboard` and not `example.com/dashboard`. Read more about subdomains in the [Routing](https://github.com/masoniteframework/docs/tree/94e8215175e7255e194fca425250b6a56ce1fe60/routing.md) documentation.
